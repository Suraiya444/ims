        ...
        ***********************************-->
        <div class="content-body">
            ...
            <form method="post" action="">
                <div class="mb-3">
                    <label class="form-label" for="department">Day Name</label>
                    <input type="text" name="day_name" class="form-control" id="day_name" placeholder="day_name" />
                </div>
            ...
            <?php 
                if($_POST){
                    ...
                    $_POST['created_by']=1;
                    $rs=$mysqli->common_create('day_name',$_POST);
                    if($rs){
                        if($rs['data']){
