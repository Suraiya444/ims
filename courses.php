...
<html lang="en">
  ...
  <body>
   ...
   <table class="table table-striped table-bordered">
                        <tr>
                            <th class="table-danger">SL No</th>
                            <th class="table-danger">Courses</th>
                                ...
                                <td class="table-danger">Social Science</td>
                                ...
                                <td class="table-danger"> Communication</td>
                                ...
                                <td class="table-danger">Religion</td>
                                ...
                                <td class="table-danger">Biology</td>
                                ...
                                <td>Pghysics</td>
                                                    ...
                                                    <tr>
                                <td class="table-danger">12</td>
                                <td class="table-danger">Management</td>
                                ...
                                <td>Accounting</td>
                                                    ...
                                                    <tr>
                                <td class="table-danger">14</td>
                                <td class="table-danger">HISTORY</td>
		...
		<section class="ftco-section">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 course d-lg-flex ftco-animate">
						<div class="img" style="background-image: url(iassets/front/mages/course-3.jpg);"></div>
						<div class="text bg-light p-4">
