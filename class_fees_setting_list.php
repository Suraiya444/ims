...
<?php 
    ...
    if(isset($_GET['class_id']) && $_GET['group_id'] && $_GET['session_id']){
        $result=$mysqli->common_select_query("SELECT class_fees_setting.*, fees_category.name FROM `class_fees_setting` 
                                        JOIN fees_category on fees_category.id=class_fees_setting.fees_id                                 
                                        where class_fees_setting.class_id={$_GET['class_id']} and class_fees_setting.group_id={$_GET['group_id']} and class_fees_setting.session_id={$_GET['session_id']}");
    }    
?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                ?>
                                                    <td>
                                                        <?php 
                                                            if(isset($fees_category[$p->name])){
                                                                echo $fees_category[$d->sl][$p->sl]->amount;
